...
import BloodRequestSendTable from "./table/BloodRequestSendTable";

const BloodRequestSend = () => {
  ...
  return (
    <>
      <SectionCommonTable
        ...
        sectionTableTitle={`Blood Request sended (${
          data?.total > 0 ? data?.total : "0"
        })`}
        data={data?.donations}
        setFilterData={setFilterData}
        table={
          <BloodRequestSendTable
...
export default BloodRequestSend;
